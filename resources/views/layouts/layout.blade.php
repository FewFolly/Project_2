...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 col-6">
            <li class="nav-item">
                <a class="nav-link active nav-header" aria-current="page" href="/">Главная</a>
            </li>
        ...
        <form class="d-flex" action="{{route('post.index')}}">
            <input class="form-control me-2 search_1" name="search" type="search" placeholder="Найти пост" aria-label="Search">
